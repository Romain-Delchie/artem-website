...
export default function QuotationList() {
    ...
    const uniqueCompanies = [...new Set(quotations.map(quotation => quotation.account_company))].sort((a, b) => {
                        ...
                        uniqueCompanies.map((company, index) => {
                            return (
                                <div key={index} className="quotation-list-company">
                                    ...
                                    <ul>
                                        {
                                            quotations.filter(quotation => quotation.account_company === company).map((quotation, index) => {
                                                return (
                                                    <li key={index}>
                                                        < button onClick={() => openModal(quotation.quotation_id)} to={`/quotation-list/${quotation.quotation_id}`} className="quotation-list-item">
                                                        ...
                                                        {modalOpenState[quotation.quotation_id] && (
                                                            <div className="quotation-list-modal">
                                                                ...
                                                                <button className="quotation-list-modal-close" onClick={() => closeModal(quotation.quotation_id)}>
                                                                    X
                                                                </button>
