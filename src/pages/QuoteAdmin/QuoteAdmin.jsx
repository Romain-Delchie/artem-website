...
export default function QuoteAdmin({ quote }) {
    ...
    console.log(quote);
    const totalPrice = quote.products === null ? 0 : quote.products.reduce((acc, product) => acc + goodPrice(quote.account_profile_id, product, product.quantity) * product.quantity, 0);
